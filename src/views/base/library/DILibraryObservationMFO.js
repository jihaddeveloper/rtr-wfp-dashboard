...
const DILibraryObservationNrFO = () => {
            ...
            <CAccordion alwaysOpen>
              ...
              <CAccordionItem itemKey={2}>
                ...
                <CAccordionBody>
                  <CRow>
                    <MaterialTable
                      title={allDILibraryObservation.length + ' Library Observation '}
                      columns={[
              ...
              <CAccordionItem itemKey={3}>
                ...
                <CAccordionBody>
                  <CRow>
                    <CCol sm={6}>
                      <strong>MFO Library Observation Rating {previousMonthYear}</strong>
                      <CTable>
                        <CTableHead>
                          <CTableRow>
                            <CTableHeaderCell scope="col">Level</CTableHeaderCell>
                    ...
                    <CCol sm={6}>
                      <strong>MFO Library Observation Status {previousMonthYear}</strong>
                      <CTable>
                        <CTableHead>
                          <CTableRow>
                            <CTableHeaderCell scope="col">Rating</CTableHeaderCell>
                ...
                <CAccordionBody>
                  <CRow>
                    <MaterialTable
                      title={allDILibraryObsvDataMFO.length + ' Library Observation '}
                      columns={[
                        { title: 'school', field: 'school' },
                        {
                          title: 'date',
              ...
              <CAccordionItem itemKey={4}>
                ...
                <CAccordionBody>
                  <CRow>
                    <CCol sm={6}>
                      <strong>NrFO Library Observation Rating {previousMonthYear}</strong>
                      <CTable>
                        <CTableHead>
                          <CTableRow>
                            <CTableHeaderCell scope="col">Level</CTableHeaderCell>
                    ...
                    <CCol sm={6}>
                      <strong>NrFO Library Observation Status {previousMonthYear}</strong>
                      <CTable>
                        <CTableHead>
                          <CTableRow>
                            <CTableHeaderCell scope="col">Rating</CTableHeaderCell>
                ...
                <CAccordionBody>
                  <CRow>
                    <MaterialTable
                      title={allDILibraryObsvDataNrFO.length + ' Library Observation '}
                      columns={[
                        { title: 'school', field: 'school' },
                        {
                          title: 'date',
...
export default DILibraryObservationNrFO
