  ...
  const getAllBookCheckoutDI = async () => {
    ...
    try {
      ...
      allTotalStudentJune24 = response.data
        .filter(
          (item) => item.year === '2024' && item.month === 'June' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
      ...
      allTotalStudentJuly24 = response.data
        .filter(
          (item) => item.year === '2024' && item.month === 'July' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
      ...
      allTotalStudentAugust24 = response.data
        .filter(
          (item) => item.year === '2024' && item.month === 'August' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
      ...
      allNoBCOPerStudentAugust24 = (
        ...
        response.data
          .filter(
            (item) =>
              item.year === '2024' && item.month === 'August' && item.office.includes('NrFO'),
          )
          .map((ureportdata) => ureportdata.schoolTotalNoStudent)
          .reduce(function (acc, value) {
            return acc + value
      ...
      allTotalStudentSeptember24 = response.data
        .filter(
          (item) =>
            item.year === '2024' && item.month === 'September' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
      ...
      allTotalStudentOctober24 = response.data
        .filter(
          (item) =>
            item.year === '2024' && item.month === 'October' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
      ...
      allTotalStudentNovember24 = response.data
        .filter(
          (item) =>
            item.year === '2024' && item.month === 'November' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
      ...
      allTotalStudentDecember24 = response.data
        .filter(
          (item) =>
            item.year === '2024' && item.month === 'December' && item.office.includes('NrFO'),
        )
        .map((ureportdata) => ureportdata.schoolTotalNoStudent)
        .reduce(function (acc, value) {
          return acc + value
    ...
    <CRow>
      <CCol xs={12}>
        <CCard className="mb-4">
          <CCardHeader>
            <strong>BCO Analysis-2024 NrFO</strong>
          </CCardHeader>
          <CCardBody>
            <MaterialTable
              title={''}
        ...
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Average Book Checkout Per Student-2024 NrFO</strong>
          </CCardHeader>
          <CCardBody>
            <CChart
              type="line"
        ...
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Number of Book Checkout Checkin-2024 NrFO</strong>
          </CCardHeader>
          <CCardBody>
            <CChart
              type="line"
        ...
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Number of Student Checkout Checkin-2024 NrFO</strong>
          </CCardHeader>
          <CCardBody>
            <CChart
              type="line"
        ...
        <CCard className="mb-4">
          <CCardHeader>
            <strong>Percent of Student Checkout Checkin-2024 NrFO</strong>
          </CCardHeader>
          <CCardBody>
            <CChart
              type="line"
        ...
        <CCard className="mb-4">
          <CCardHeader>
            <strong>All BCO Data-2024 NrFO</strong>
          </CCardHeader>
          <CCardBody>
            <MaterialTable
              title={allDIBCODataNrFO.length + ' BCO Data'}
              columns={[
